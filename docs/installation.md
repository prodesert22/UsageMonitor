...
```bash
sudo dpkg -i usage-monitor-cli_0.10.4-1_amd64.deb
...
```bash
sudo rpm -i usage-monitor-cli-0.10.4-1.x86_64.rpm
# or: sudo dnf install ./usage-monitor-cli-0.10.4-1.x86_64.rpm
```
...
```bash
sudo pacman -U usage-monitor-cli-bin-0.10.4-1-x86_64.pkg.tar.zst
```
...
```bash
tar -xzf usage-monitor-cli-0.10.4-linux-x86_64.tar.gz
cd usage-monitor-cli-0.10.4-linux-x86_64
...
```bash
chmod +x UsageMonitor-0.10.4-linux-x86_64.AppImage
./UsageMonitor-0.10.4-linux-x86_64.AppImage list
```
...
```bash
flatpak install --user UsageMonitor-0.10.4-linux-x86_64.flatpak
